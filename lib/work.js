export const work = () => {
  ...
  const openProjectModal = (project, triggerElement = null) => {
    ...
    const isMelanomaProject = projectName.toLowerCase() === "melanoma";

    projectModalTitle.textContent = projectName;
    if (projectModalTitleDisplay) {
      projectModalTitleDisplay.textContent = projectName;
      projectModalTitleDisplay.classList.toggle("is-melanoma", isMelanomaProject);
    }
    ...
    if (projectModalTitleRunA && projectModalTitleRunB) {
      ...
      projectModalTitleRunA.classList.toggle("is-melanoma", isMelanomaProject);
      projectModalTitleRunB.classList.toggle("is-melanoma", isMelanomaProject);
    }
  ...
  const createWorkLink = (project) => {
    ...
    link.setAttribute("aria-label", `view ${projectName} details`);
    ...
    link.append(icon, document.createTextNode(projectName));
    if (projectName.toLowerCase() === "melanoma") {
      link.classList.add("is-melanoma");
    }
